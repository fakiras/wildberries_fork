...
const file_admin_proto_rawDesc = "" +
	...
	"\n" +
	"Moderation\x12\x1fОтклонить заявку\x1a9Отклонение заявки на модерацию*\x06Reject\x82\xd3\xe4\x93\x02.:\x01*\")/admin/moderation/{application_id}/rejectB\xb6\x02\x92A\x95\x02\x12\xdb\x01\n" +
	"@Сервис управления заказами для ПВЗ\x12\x8f\x01Сервис выполняет функции для выдачи, добавления, возврата и просмотра заказов2\x051.0.0\x1a\x0elocalhost:7002*\x01\x012\x10application/json:\x10application/jsonZ\x1bwildberries/pkg/admin;adminb\x06proto3"
